...
(2, '木上幹雄', '', '08056006603', '書換', '常務取締役', '2025-02-26 11:23:51', '2025-02-28 07:29:15'),
(3, '深川勝博', '', '08056006606', '書換', '係長', '2025-02-27 03:14:15', '2025-02-28 07:29:10'),
(4, '高岩', '', '', '営業久留米', '専務取締役', '2025-02-28 00:40:28', '2025-02-28 07:27:01'),
(5, '宮之原', '', '', '営業久留米', '課長', '2025-02-28 07:21:55', '2025-02-28 07:21:55'),
(6, '田畑', '', '', '営業久留米', '主任', '2025-02-28 07:22:14', '2025-02-28 07:22:14'),
(7, '倉満', '', '', '営業久留米', '車輛長', '2025-02-28 07:22:41', '2025-02-28 07:27:48'),
(8, '吉永', '', '', '営業久留米', '車輛長', '2025-02-28 07:23:33', '2025-02-28 07:28:16'),
(9, '田中', '', '', '営業都城', '車輛長', '2025-02-28 07:24:07', '2025-02-28 07:28:39'),
(10, '石原', '', '', '営業久留米', '主任', '2025-02-28 07:24:37', '2025-02-28 07:29:03'),
(11, '森高', '', '', '営業久留米', '主任', '2025-02-28 07:25:02', '2025-02-28 07:25:02'),
(12, '古屋敷', '', '', '管理', '主任', '2025-02-28 07:25:26', '2025-03-04 02:21:29'),
(13, '早野', '', '', 'アポイント', '主査', '2025-02-28 07:31:31', '2025-03-04 02:18:09'),
...
CREATE TABLE `orders` (
  ...
  `negotiation_status` enum('未設定','進行中','与信怪しい','工事前再説','工事後再説','工事前キャンセル','工事後キャンセル','書換完了') DEFAULT NULL,
  `construction_status` enum('待ち','与信待ち','残あり','完了','回収待ち') DEFAULT NULL,
...
INSERT INTO `orders` (`id`, `customer_name`, `customer_type`, `order_date`, `monthly_fee`, `total_payments`, `revision_total`, `negotiation_status`, `construction_status`, `credit_status`, `document_status`, `rewrite_status`, `seal_certificate_status`, `memo`, `sales_rep_id`, `sales_rep_id_2`, `sales_rep_id_3`, `sales_rep_id_4`, `appointment_rep_id_1`, `appointment_rep_id_2`, `rewriting_person_id`, `company_id`) VALUES
(17, '（有）木村設備', '既存', '2025-02-27', 37800, 84, 30000, '進行中', '待ち', '与信OK', '準備中', 'アポOK', NULL, '工事3/3', 7, 10, NULL, NULL, NULL, NULL, NULL, NULL),
(18, '（株）一弘', '既存', '2025-02-28', 39800, 84, NULL, '進行中', '待ち', '与信中', NULL, NULL, NULL, NULL, 4, 6, NULL, NULL, NULL, NULL, NULL, 39),
(19, '（有）春日浦溶接', '既存', '2025-02-28', 35800, 84, NULL, '進行中', '待ち', '与信中', NULL, NULL, NULL, NULL, 7, 10, NULL, NULL, NULL, NULL, NULL, 38);
...
ALTER TABLE `sales_points`
  ...
  ADD CONSTRAINT `sales_points_ibfk_2` FOREIGN KEY (`sales_rep_id`) REFERENCES `employees` (`employee_id`);
COMMIT;
